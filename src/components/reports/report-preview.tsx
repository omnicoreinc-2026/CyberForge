    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <motion.button
            ...
            className="flex items-center gap-2 rounded-lg bg-accent px-4 py-2 text-sm font-medium text-bg-primary hover-glow-accent"
          >
      ...
      <div className="glass-card overflow-hidden">
        <div className="bg-gradient-to-r from-[#0a0a1a] via-[#16213e] to-[#0f3460] p-6 text-white">
          ...
          <p className="mt-1 text-sm text-[#8ecae6]">CyberLancer Security Assessment Report</p>
      ...
      <div className="text-center text-xs text-text-muted py-4 border-t border-border">
        Generated by CyberLancer Strike Platform
      </div>
    </motion.div>
  );
}
